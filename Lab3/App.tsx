...
//   return (
//     <View style={styles.container}>
//       <TouchableOpacity style={{ backgroundColor: '#33CCFF', width: 50, height: 40, justifyContent: 'center', alignItems: 'center' }} onPress={handleMovePress}>
